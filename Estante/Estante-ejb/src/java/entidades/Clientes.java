...
@NamedQueries({
    ...
    , @NamedQuery(name = "Clientes.login", query = "SELECT c FROM Clientes c WHERE c.senha = :senha AND c.email = :email")})
public class Clientes implements Serializable {
    ...
    public Clientes(Integer idCliente, String nome, String endereco, String cidade, String uf, String telefone, String email) {
        this.idCliente = idCliente;
        this.nome = nome;
    ...
    public String toString() {
        return "orm.Clientes[ idCliente=" + idCliente + " ]";
    }
